...
```{r}
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=0.01)
...
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=0.001)
imputed = complete(mean_degree_matrix,fit1)
...
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=3)
imputed = complete(mean_degree_matrix,fit1)
...
cat("RMSE, characteristics (Bicomp) direct imp:", rmse2, "\n")
cat("RMSE, characteristics (Bicomp) glee imp  :", rmse3,"\n")
cat("RMSE, characteristics (Bicomp) tensor imp:", rmse1,"\n")
cat("RMSE, characteristics (Bicomp) char imp  :", rmse)
```
...
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=1)
imputed = complete(mean_degree_matrix,fit1)
...
cat("RMSE, characteristics (transitivity) direct imp:", rmse2, "\n")
cat("RMSE, characteristics (transitivity) glee imp  :", rmse3,"\n")
cat("RMSE, characteristics (transitivity) tensor imp:", rmse1,"\n")
cat("RMSE, characteristics (transitivity) char imp  :", rmse)
```
...
rmse = sqrt(sum((imputed-mean_degree_matrix_real)^2) / 7)
```
...
rmse1 = sqrt(sum((mean_degree_matrix_tensor-mean_degree_matrix_real)^2) / 7)
rmse2 = sqrt(sum((mean_degree_matrix_direct-mean_degree_matrix_real)^2) / 7)
rmse3 = sqrt(sum((mean_degree_matrix_glee-mean_degree_matrix_real)^2) / 7)
...
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=1.5)
imputed = complete(mean_degree_matrix,fit1)
...
fit1 <-softImpute(mean_degree_matrix,rank=1,lambda=400)
imputed = complete(mean_degree_matrix,fit1)
